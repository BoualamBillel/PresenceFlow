...
class FormateurProfilController extends AbstractController
{
    #[Route('/formateur/profil', name: 'app_formateur_profil')]
    public function index(Request $request, EntityManagerInterface $em, UserManager $userManager): Response
    {
        ...
        if ($formEmail->isSubmitted() && $formEmail->isValid()) {
            ...
            return $this->redirectToRoute('app_formateur_profil');
        }
        ...
        return $this->render('formateur/profil.html.twig', [
